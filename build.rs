...
const CARGO_RUSTC_LINK_SEARCH_NATIVE_LUA_5_5_0: &str = "cargo:rustc-link-search=native=./lua-5.5.0";
...
const CARGO_RUSTC_LINK_LIB_STATIC_CLUA_5_5_0: &str = "cargo:rustc-link-lib=static=clua_5_5_0";
