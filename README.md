...
![docs.rs](https://img.shields.io/docsrs/rclua?link=https%3A%2F%2Fdocs.rs%2Frclua%2F1.0.3%2Frclua%2F)
...
*this document assumes RCLua v1.0.3*
...
# add [dependencies] rclua = "1.0.3" to Cargo.toml.
...
[dependencies]
rclua = { path = "../rclua", version = "1.0.3" }
```
